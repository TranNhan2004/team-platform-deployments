...
: "${TEAM_ORGANIZATION_DB:?TEAM_ORGANIZATION_DB is required}"
: "${TEAM_ORGANIZATION_DB_USERNAME:?TEAM_ORGANIZATION_DB_USERNAME is required}"
: "${TEAM_ORGANIZATION_DB_PASSWORD:?TEAM_ORGANIZATION_DB_PASSWORD is required}"
...
: "${TEAM_CHATS_DB:?TEAM_CHATS_DB is required}"
: "${TEAM_CHATS_DB_USERNAME:?TEAM_CHATS_DB_USERNAME is required}"
: "${TEAM_CHATS_DB_PASSWORD:?TEAM_CHATS_DB_PASSWORD is required}"

: "${TEAM_IT_SERVICES_DB:?TEAM_IT_SERVICES_DB is required}"
: "${TEAM_IT_SERVICES_DB_USERNAME:?TEAM_IT_SERVICES_DB_USERNAME is required}"
: "${TEAM_IT_SERVICES_DB_PASSWORD:?TEAM_IT_SERVICES_DB_PASSWORD is required}"
...
create_role \
  "$TEAM_ORGANIZATION_DB_USERNAME" \
  "$TEAM_ORGANIZATION_DB_PASSWORD"
...
create_role \
  "$TEAM_CHATS_DB_USERNAME" \
  "$TEAM_CHATS_DB_PASSWORD"

create_role \
  "$TEAM_IT_SERVICES_DB_USERNAME" \
  "$TEAM_IT_SERVICES_DB_PASSWORD"
